...
let songs = [
    ...
    {songName: "Different Heaven & EH!DE - My Heart [NCS Release]", filePath: "songs/4.mp3", coverPath: "covers/cover4.jpg"},
    {songName: "Janji-Heroes-Tonight-feat-Johnning-NCS-Release", filePath: "songs/5.mp3", coverPath: "covers/cover5.jpg"},
...
Array.from(document.getElementsByClassName('songItemPlay')).forEach((element) => {
    element.addEventListener('click', (e) => {
        ...
        if (clickedElement.classList.contains('fa-pause-circle')) {
            clickedElement.classList.remove('fa-pause-circle');
            clickedElement.classList.add('fa-play-circle');
            audioElement.pause(); 
            gif.style.opacity = 0; 
            masterPlay.classList.remove('fa-pause-circle');
            masterPlay.classList.add('fa-play-circle');
            ...
            makeAllPlays(); 
            songIndex = parseInt(clickedElement.id); 
